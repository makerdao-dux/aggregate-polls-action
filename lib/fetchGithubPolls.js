...
function fetchGithubPolls(parsedSubgraphPolls) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let j = 0; j < subgraphPollsInChunks.length; j++) {
            const settledPolls = yield Promise.allSettled(subgraphPollsInChunks[j].map((poll) => __awaiter(this, void 0, void 0, function* () {
